...
import { Search, X, Users, Archive, Settings } from "lucide-react";
...
export function ChatClient({
  ...
  // Le Header appellera useUnreadMessages en interne avec user.id
  const headerUser = {
    id: currentUser.id,
    nom: currentUser.nom,
  ...
  const currentUserName =
    currentUser.pseudo || `${currentUser.prenom} ${currentUser.nom}`;

  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      {/* Le Header gère lui-même le badge de messages non lus via useUnreadMessages */}
